...
public:
	...
	struct FRigVMExtendedExecuteContext           ExtendedExecuteContext;                            // 0x0060(0x01C0)(NativeAccessSpecifierPrivate)
	struct FRigVMDrawContainer                    DrawContainer;                                     // 0x0220(0x0018)(NativeAccessSpecifierPublic)
	uint8                                         Pad_238[0x18];                                     // 0x0238(0x0018)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<class FName>                           EventQueue;                                        // 0x0250(0x0010)(ZeroConstructor, Transient, NativeAccessSpecifierPublic)
	uint8                                         Pad_260[0xA0];                                     // 0x0260(0x00A0)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<class UAssetUserData*>                 AssetUserData;                                     // 0x0300(0x0010)(Edit, ExportObject, ZeroConstructor, ContainsInstancedReference, AdvancedDisplay, Protected, UObjectWrapper, NativeAccessSpecifierProtected)
