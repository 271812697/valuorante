...
public:
	...
	TMulticastInlineDelegate<void(const struct FAppleImageUtilsImageConversionResult& ConversionResult)> OnSuccess; // 0x0030(0x0018)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(const struct FAppleImageUtilsImageConversionResult& ConversionResult)> OnFailure; // 0x0048(0x0018)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
