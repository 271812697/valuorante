...
public:
	...
	TDelegate<void(class UObject* Object)>        OnAssetDone;                                       // 0x0020(0x0018)(Edit, BlueprintVisible, ZeroConstructor, InstancedReference, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_38[0x18];                                      // 0x0038(0x0018)(Fixing Size After Last Property [ Dumper-7 ])
	TDelegate<void(const TArray<class UObject*>& Objects)> OnAssetsImportDone;                       // 0x0050(0x0018)(Edit, BlueprintVisible, ZeroConstructor, InstancedReference, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_68[0x18];                                      // 0x0068(0x0018)(Fixing Size After Last Property [ Dumper-7 ])
	TDelegate<void(class UObject* Object)>        OnSceneObjectDone;                                 // 0x0080(0x0018)(Edit, BlueprintVisible, ZeroConstructor, InstancedReference, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_98[0x18];                                      // 0x0098(0x0018)(Fixing Size After Last Property [ Dumper-7 ])
	TDelegate<void(const TArray<class UObject*>& Objects)> OnSceneImportDone;                        // 0x00B0(0x0018)(Edit, BlueprintVisible, ZeroConstructor, InstancedReference, HasGetValueTypeHash, NativeAccessSpecifierPublic)
