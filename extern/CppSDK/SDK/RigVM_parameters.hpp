...
{
public:
	struct FRigVMExtendedExecuteContext           Context;                                           // 0x0000(0x01C0)(Parm, OutParm, NativeAccessSpecifierPublic)
	class FName                                   InEntryName;                                       // 0x01C0(0x0008)(ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
{
public:
	struct FRigVMExtendedExecuteContext           ReturnValue;                                       // 0x0000(0x01C0)(Parm, OutParm, ReturnParm, NativeAccessSpecifierPublic)
};
