...
public:
	...
	TArray<struct FMovieSceneEvent>               KeyValues;                                         // 0x0078(0x0010)(ZeroConstructor, NativeAccessSpecifierPrivate)
...
{
public:
	struct FPerlinNoiseParams                     PerlinNoiseParams;                                 // 0x0068(0x0018)(Edit, NoDestructor, NativeAccessSpecifierPublic)
};
...
public:
	TArray<struct FFrameNumber>                   KeyTimes;                                          // 0x0068(0x0010)(ZeroConstructor, NativeAccessSpecifierPrivate)
	TArray<struct FMovieSceneCameraShakeSourceTrigger> KeyValues;                                    // 0x0078(0x0010)(ZeroConstructor, NativeAccessSpecifierPrivate)
	struct FMovieSceneKeyHandleMap                KeyHandles;                                        // 0x0088(0x0088)(Transient, NativeAccessSpecifierPrivate)
};
...
{
public:
	TArray<struct FFrameNumber>                   Times;                                             // 0x0068(0x0010)(ZeroConstructor, NativeAccessSpecifierPrivate)
	TArray<class FString>                         Values;                                            // 0x0078(0x0010)(ZeroConstructor, NativeAccessSpecifierPrivate)
	class FString                                 DefaultValue;                                      // 0x0088(0x0010)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	bool                                          bHasDefaultValue;                                  // 0x0098(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
public:
	...
	struct FMovieSceneFloatChannel                TimingCurve;                                       // 0x0038(0x0128)(NativeAccessSpecifierPublic)
	EMovieScene3DPathSection_Axis                 FrontAxisEnum;                                     // 0x0160(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EMovieScene3DPathSection_Axis                 UpAxisEnum;                                        // 0x0161(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_162[0x2];                                      // 0x0162(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	uint8                                         bFollow : 1;                                       // 0x0164(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bReverse : 1;                                      // 0x0164(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bForceUpright : 1;                                 // 0x0164(0x0001)(BitIndex: 0x02, PropSize: 0x0001 (NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
...
public:
	TArray<struct FFrameNumber>                   KeyTimes;                                          // 0x0068(0x0010)(ZeroConstructor, NativeAccessSpecifierPrivate)
	struct FMovieSceneActorReferenceKey           DefaultValue;                                      // 0x0078(0x0028)(NoDestructor, NativeAccessSpecifierPrivate)
	TArray<struct FMovieSceneActorReferenceKey>   KeyValues;                                         // 0x00A0(0x0010)(ZeroConstructor, NativeAccessSpecifierPrivate)
...
public:
	...
	struct FMovieSceneActorReferenceData          ActorReferenceData;                                // 0x0038(0x0138)(NativeAccessSpecifierPrivate)
};
...
public:
	TArray<struct FFrameNumber>                   Times;                                             // 0x0068(0x0010)(ZeroConstructor, NativeAccessSpecifierPrivate)
	TArray<struct FEventPayload>                  KeyValues;                                         // 0x0078(0x0010)(ZeroConstructor, NativeAccessSpecifierPrivate)
	struct FMovieSceneKeyHandleMap                KeyHandles;                                        // 0x0088(0x0088)(Transient, NativeAccessSpecifierPrivate)
};
...
{
public:
	struct FMovieSceneEventSectionData            EventData;                                         // 0x0020(0x0110)(NativeAccessSpecifierPublic)
	uint8                                         bFireEventsWhenForwards : 1;                       // 0x0130(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bFireEventsWhenBackwards : 1;                      // 0x0130(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
...
{
public:
	struct FMovieSceneObjectPathChannel           ObjectChannel;                                     // 0x0038(0x0148)(NativeAccessSpecifierPrivate)
};
...
public:
	...
	struct FMovieSceneFloatChannel                ParameterCurve;                                    // 0x0008(0x0128)(NativeAccessSpecifierPublic)
};
...
public:
	class FName                                   ParameterName;                                     // 0x0000(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FMovieSceneBoolChannel                 ParameterCurve;                                    // 0x0008(0x0118)(NativeAccessSpecifierPublic)
};
...
public:
	class FName                                   ParameterName;                                     // 0x0000(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FMovieSceneFloatChannel                Translation[0x3];                                  // 0x0008(0x0128)(NativeAccessSpecifierPublic)
	struct FMovieSceneFloatChannel                Rotation[0x3];                                     // 0x0380(0x0128)(NativeAccessSpecifierPublic)
	struct FMovieSceneFloatChannel                Scale[0x3];                                        // 0x06F8(0x0128)(NativeAccessSpecifierPublic)
};
...
{
public:
	struct FMovieSceneParticleChannel             ParticleKeys;                                      // 0x0020(0x0120)(NativeAccessSpecifierPublic)
};
...
{
public:
	struct FMovieSceneBoolChannel                 BoolCurve;                                         // 0x0038(0x0118)(Protected, NativeAccessSpecifierProtected)
};
...
{
public:
	struct FMovieSceneFloatChannel                SlomoCurve;                                        // 0x0020(0x0128)(NativeAccessSpecifierPrivate)
};
...
public:
	...
	struct FMovieSceneFloatChannel                Weight;                                            // 0x0030(0x0128)(NativeAccessSpecifierPublic)
	bool                                          bSkipAnimNotifiers;                                // 0x0158(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bForceCustomMode;                                  // 0x0159(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	ESwapRootBone                                 SwapRootBone;                                      // 0x015A(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_15B[0x1];                                      // 0x015B(0x0001)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         StartOffset;                                       // 0x015C(0x0004)(ZeroConstructor, Deprecated, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         EndOffset;                                         // 0x0160(0x0004)(ZeroConstructor, Deprecated, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
