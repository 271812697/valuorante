...
// ScriptStruct Localization.UserGeneratedContentLocalizationDescriptor
// 0x0028 (0x0028 - 0x0000)
struct FUserGeneratedContentLocalizationDescriptor final
{
public:
	class FString                                 NativeCulture;                                     // 0x0000(0x0010)(Edit, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TArray<class FString>                         CulturesToGenerate;                                // 0x0010(0x0010)(Edit, ZeroConstructor, NativeAccessSpecifierPublic)
	EPortableObjectFormat                         PoFormat;                                          // 0x0020(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_21[0x7];                                       // 0x0021(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
DUMPER7_ASSERTS_FUserGeneratedContentLocalizationDescriptor;
...
public:
	...
	TArray<class FString>                         FieldTypesToInclude;                               // 0x0038(0x0010)(Edit, ZeroConstructor, Config, NativeAccessSpecifierPublic)
	TArray<class FString>                         FieldTypesToExclude;                               // 0x0048(0x0010)(Edit, ZeroConstructor, Config, NativeAccessSpecifierPublic)
	TArray<class FString>                         FieldOwnerTypesToInclude;                          // 0x0058(0x0010)(Edit, ZeroConstructor, Config, NativeAccessSpecifierPublic)
	TArray<class FString>                         FieldOwnerTypesToExclude;                          // 0x0068(0x0010)(Edit, ZeroConstructor, Config, NativeAccessSpecifierPublic)
	bool                                          ShouldGatherFromEditorOnlyData;                    // 0x0078(0x0001)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
{
public:
	struct FDirectoryPath                         RawAudioPath;                                      // 0x0000(0x0010)(Edit, ZeroConstructor, Config, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
public:
	...
	struct FGatherTextFromMetaDataConfiguration   GatherFromMetaData;                                // 0x00F8(0x0080)(Edit, Config, NativeAccessSpecifierPublic)
	struct FLocalizationExportingSettings         ExportSettings;                                    // 0x0178(0x0004)(Edit, Config, NoDestructor, NativeAccessSpecifierPublic)
	struct FLocalizationCompilationSettings       CompileSettings;                                   // 0x017C(0x0003)(Edit, Config, NoDestructor, NativeAccessSpecifierPublic)
	uint8                                         Pad_17F[0x1];                                      // 0x017F(0x0001)(Fixing Size After Last Property [ Dumper-7 ])
	struct FLocalizationImportDialogueSettings    ImportDialogueSettings;                            // 0x0180(0x0028)(Edit, Config, NativeAccessSpecifierPublic)
	int32                                         NativeCultureIndex;                                // 0x01A8(0x0004)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_1AC[0x4];                                      // 0x01AC(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<struct FCultureStatistics>             SupportedCulturesStatistics;                       // 0x01B0(0x0010)(Edit, ZeroConstructor, Config, NativeAccessSpecifierPublic)
};
