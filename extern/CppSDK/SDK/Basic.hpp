...
namespace Offsets
{
	constexpr int32 GObjects          = 0x0E784A20;
	constexpr int32 AppendString      = 0x011AE670;
	constexpr int32 GNames            = 0x0E641720;
	constexpr int32 GWorld            = 0x0E96EF28;
	constexpr int32 ProcessEvent      = 0x018BA3D0;
