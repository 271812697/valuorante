...
namespace Offsets
{
	constexpr int32 GObjects          = 0x04A00410;
	constexpr int32 AppendString      = 0x00FF6870;
	constexpr int32 GNames            = 0x049C40C0;
	constexpr int32 GWorld            = 0x04B48780;
	constexpr int32 ProcessEvent      = 0x011E7500;
