...
public:
	...
	struct FMovieSceneFloatChannel                ProxyTextureBlend;                                 // 0x0050(0x0128)(NativeAccessSpecifierPublic)
};
...
{
public:
	struct FMovieSceneMediaSectionParams          Params;                                            // 0x0020(0x0178)(ContainsInstancedReference, NativeAccessSpecifierPrivate)
	class UMovieSceneMediaSection*                MediaSection;                                      // 0x0198(0x0008)(ExportObject, ZeroConstructor, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
};
