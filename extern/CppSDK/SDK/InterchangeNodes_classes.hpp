...
public:
	...
	void GetCustomAnimationTrackUid(const int32 index, class FString* OutAnimationTrackUid) const;
...
public:
	...
	void GetCustomVariantSetUid(const int32 index, class FString* OutVariantUid) const;
...
public:
	...
	void GetCustomDependencyUid(const int32 index, class FString* OutDependencyUid) const;
...
public:
	...
	void GetMorphTargetDependency(const int32 index, class FString* OutDependency) const;
	bool GetMorphTargetName(class FString* OutMorphTargetName) const;
	void GetSceneInstanceUid(const int32 index, class FString* OutDependency) const;
	...
	void GetSkeletonDependency(const int32 index, class FString* OutDependency) const;
...
public:
	...
	void GetSlotMaterialDependencies(TMap<class FString, class FString>* OutMaterialDependencies) const;
	bool GetSlotMaterialDependencyUid(const class FString& SlotName, class FString* OutMaterialDependency) const;
	void GetSpecializedType(const int32 index, class FString* OutSpecializedType) const;
