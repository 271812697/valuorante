...
struct FScriptTypedElementHandle UTypedElementListLibrary::GetElementHandleAt(const struct FScriptTypedElementListProxy& ElementList, const int32 index)
{
	static class UFunction* Func = nullptr;
...
bool UTypedElementListLibrary::IsValidIndex(const struct FScriptTypedElementListProxy& ElementList, const int32 index)
{
	static class UFunction* Func = nullptr;
