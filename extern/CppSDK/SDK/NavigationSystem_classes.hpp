...
public:
	...
	uint8                                         Pad_350[0x108];                                    // 0x0350(0x0108)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<struct FSupportedAreaData>             SupportedAreas;                                    // 0x0458(0x0010)(ZeroConstructor, Protected, NativeAccessSpecifierProtected)
	uint8                                         Pad_468[0x58];                                     // 0x0468(0x0058)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	TArray<struct FNavCollisionCylinder>          CylinderCollision;                                 // 0x00A8(0x0010)(Edit, ZeroConstructor, NativeAccessSpecifierPublic)
	TArray<struct FNavCollisionBox>               BoxCollision;                                      // 0x00B8(0x0010)(Edit, ZeroConstructor, NativeAccessSpecifierPublic)
	TSubclassOf<class UNavArea>                   AreaClass;                                         // 0x00C8(0x0008)(Edit, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         bGatherConvexGeometry : 1;                         // 0x00D0(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, Config, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bCreateOnClient : 1;                               // 0x00D0(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (Edit, Config, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
...
{
public:
	TMulticastInlineDelegate<void(class UNavigationPath* AffectedPath, ENavPathEvent PathEvent)> PathUpdatedNotifier; // 0x0028(0x0018)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	...
	uint8                                         Pad_51[0x47];                                      // 0x0051(0x0047)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
// 0x1608 (0x1630 - 0x0028)
class alignas(0x10) UNavigationSystemV1 final : public UNavigationSystemBase
{
public:
	...
	TMulticastInlineDelegate<void(class ANavigationData* NavData)> OnNavDataRegisteredEvent;         // 0x0108(0x0018)(ZeroConstructor, Transient, InstancedReference, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(class ANavigationData* NavData)> OnNavigationGenerationFinishedDelegate; // 0x0120(0x0018)(ZeroConstructor, Transient, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	uint8                                         Pad_138[0xE8];                                     // 0x0138(0x00E8)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_221[0x140F];                                   // 0x0221(0x140F)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	TArray<struct FNavigationLink>                Links;                                             // 0x0588(0x0010)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, NativeAccessSpecifierPublic)
...
public:
	...
	uint8                                         Pad_1A1[0x4F];                                     // 0x01A1(0x004F)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_5D8[0x88];                                     // 0x05D8(0x0088)(Fixing Struct Size After Last Property [ Dumper-7 ])
