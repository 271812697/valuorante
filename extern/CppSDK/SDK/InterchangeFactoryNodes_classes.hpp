...
public:
	...
	void GetAnimatedAttributeCurveName(const int32 index, class FString* OutAttributeCurveName) const;
	...
	void GetAnimatedAttributeStepCurveName(const int32 index, class FString* OutAttributeStepCurveName) const;
	...
	void GetAnimatedMaterialCurveSuffixe(const int32 index, class FString* OutMaterialCurveSuffixe) const;
