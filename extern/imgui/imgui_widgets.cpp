...
int accent_color[4] = { 265, 255, 255, 255 };
...
bool ImGui::Checkbox(const char* label, bool* v)
{
    ...
    RenderCheckMark(window->DrawList, frame_bb.GetCenter() - ImVec2((square_sz / 2 + 1) / 2, (square_sz / 2 + 1) / 2), ImColor(21, 20, 27), square_sz / 2 + 1);
...
bool ImGui::BeginCombo(const char* label, const char* preview_value, ImGuiComboFlags flags)
{
    ...
    if (!(flags & ImGuiComboFlags_NoPreview))
        window->DrawList->AddRectFilled(bb.Min, ImVec2(value_x2, bb.Max.y), ImColor(26, 25, 32), style.FrameRounding, (flags & ImGuiComboFlags_NoArrowButton) ? ImColor(26, 25, 32) : ImColor(21, 20, 27));
    ...
    if (!(flags & ImGuiComboFlags_NoArrowButton))
    {
        ...
        if (value_x2 + arrow_size - style.FramePadding.x <= bb.Max.x)
            RenderArrow(window->DrawList, ImVec2(value_x2 + style.FramePadding.y, bb.Min.y + style.FramePadding.y), GetColorU32(ImGuiCol_Text, popup_open ? 1.f : 0.3f), ImGuiDir_Down, 1.0f);
